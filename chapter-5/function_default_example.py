...
def customer_bill_summary(customer_name, quantity, discount=10):
...
customer_bill_summary('Zahid', 50, 50)
customer_bill_summary('Haider', 50)
cust = customer_bill_summary(discount=30,customer_name='Zidan',quantity=400)
print(cust)